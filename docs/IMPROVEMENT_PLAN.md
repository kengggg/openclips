...
| 06 | GitHub PR open (not merged) | [#9](https://github.com/kengggg/openclips/pull/9) `pr-06-cli-contracts` | Offline CLI JSON/exit tests, encode/help/version consumer. Hardware: **untested**. |
