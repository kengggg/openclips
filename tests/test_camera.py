...
from openclips.camera import Camera, CameraAsleep, CameraError, NotPaired, PairingKeyMismatch, extract_jpeg
...
def test_sessions_and_moments():
    lens, cam = make_paired(sessions={SID: [2, 3, 1, 9, 4, 5], 42: []})
    cam.resume()
    s = cam.list_sessions()
